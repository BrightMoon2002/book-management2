                            ...
                            <div class="col-3">
                                <div class="card" style="width: 100%;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Author: <a href="books?action=search&searchP=${book.getProducer()}"><c:out value="${book.producer}"/></a></p>
                                        <p class="card-text">Category: <a href="books?action=search&searchC=${book.category.name}"><c:out value="${book.category.name}"/></a> </p>
